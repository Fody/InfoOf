...
// from here http://ikvm.cvs.sourceforge.net/viewvc/ikvm/ikvm/reflect/TypeNameParser.cs?content-type=text%2Fplain
...
namespace IKVM.Reflection
{
        ...
        struct TypeName : IEquatable<TypeName>
        {
	        ...
	        struct TypeNameParser
	        {
	                ...
	                private readonly string name;
                    internal readonly string[] nested;
	                private readonly string assemblyName;
                    internal readonly short[] modifiers;
	                internal readonly TypeNameParser[] genericParameters;
